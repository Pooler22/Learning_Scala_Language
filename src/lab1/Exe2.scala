...
object Exe2 extends App {
  //Version 1
  def isPerfectNumber_v1(n: Int): Boolean = {
    var sum = 1
  ...
  //Version 2
  def isPerfectNumber_v2(n: Int): Boolean = {
  ...
  vector1.foreach(x => println("Is Excellent: " + isPerfectNumber_v2(x)))

  val vector2 = Vector[Int](5, 34, 324, 2346)
  println("vector:" + vector2 + " ,result:")
  vector2.foreach(x => println("Is Excellent: " + isPerfectNumber_v2(x)))
}
